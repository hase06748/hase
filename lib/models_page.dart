      ...
      child: Column(
        ...
        children: const [
          ...
          Text(
            ...
            'تتطلب هندسة SOTA المتكاملة النماذج الخمسة (SwinIR للتكبير، CodeFormer للوجوه، NAFNet للتنظيف، RetinaFace للاكتشاف، SFace للمطابقة) لضمان أعلى جودة معالجة متقدمة.',
            style: TextStyle(
